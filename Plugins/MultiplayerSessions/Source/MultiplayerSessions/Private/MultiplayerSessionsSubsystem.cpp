...
void UMultiplayerSessionsSubsystem::CreateSession(int32 NumPublicConnections, FString MatchType)
{
	...
	if (auto ExistingSession = SessionInterface->GetNamedSession(NAME_GameSession); ExistingSession)
	{
	...
	// Store the delegate in handle so we can later remove it in delegate list
	...
	LastSessionSettings->Set(FName("LobbyType"), MatchType, EOnlineDataAdvertisementType::ViaOnlineServiceAndPing);
